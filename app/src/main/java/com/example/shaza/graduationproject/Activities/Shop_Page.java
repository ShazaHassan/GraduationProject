...
public class Shop_Page extends AppCompatActivity
    ...
    private void setHeaderDrawer() {
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent pp = new Intent(Shop_Page.this, Personal_Page.class);
                startActivity(pp);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.category_for_shop, menu);
        return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.getItemId();
        String cat = "category";
        Intent catPage = new Intent(this, CategoryPageShop.class);
        if (id == R.id.all_projects) {
            catPage.putExtra(cat, "All products");
