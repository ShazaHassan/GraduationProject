...
public class SuccessEquityCampaign extends Fragment {
    View rootView;
        ...
        campaignTable.orderByKey().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (campaigns.size() != 0) {
                    ...
                    adapter = new AdapterForShowEquityCampaign(getActivity(), campaigns, R.color.lightBlue);
